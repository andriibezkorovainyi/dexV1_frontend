...
export function EasterEggComponent(props: EasterEggRenderProps) {
    const canvas = React.useRef<HTMLCanvasElement>(null);

    if (canvas.current) beginEasterEgg(canvas.current, props);
